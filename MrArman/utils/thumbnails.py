...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("MrArman/assets/font2.ttf", 30)
        font = ImageFont.truetype("MrArman/assets/font.ttf", 30)
        title_font = ImageFont.truetype("MrArman/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("MrArman/assets/play_icons.png")
